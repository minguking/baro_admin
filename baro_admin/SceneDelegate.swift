...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createMainNC() -> UINavigationController {
        ...
        mainView.tabBarItem = UITabBarItem(title: "Home",
    ...
    func createSecondNC() -> UINavigationController {
        let mainView = CalculateViewController()
        mainView.tabBarItem = UITabBarItem(title: "other",
    ...
    func createThirdNC() -> UINavigationController {
        let mainView = ThirdViewController()
        mainView.tabBarItem = UITabBarItem(title: "another",
                                         image: UIImage(systemName: "house.fill"),
                                         tag: 0)
    ...
    func creatTabBar() -> UITabBarController {
        ...
        tabBar.viewControllers = [createMainNC(),
                                  createSecondNC(),
                                  createThirdNC()
                                    ]
        return tabBar
